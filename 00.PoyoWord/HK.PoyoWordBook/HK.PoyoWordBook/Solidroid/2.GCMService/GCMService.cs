...
namespace Solidroid
{
	...
	public class GcmBroadcastReceiver : GcmBroadcastReceiverBase<PushHandlerService>
	{
		...
		public static string[] SENDER_IDS = new string[] { "647652729285 " };
	...
	public class PushHandlerService : GcmServiceBase
	{
		...
		protected override void OnRegistered(Context context, string registrationId)
		{
			...
			broadcast.SetAction(StaticValue.GCMREGISTER);
			broadcast.PutExtra(StaticValue.RESULT, registrationId);
		...
		protected override void OnMessage(Context context, Intent intent)
		{
			...
			//			var edit = prefs.Edit();
			//			edit.PutString(StaticValue.GCMMESSAGE, msg.ToString());
			//			edit.Commit();

			//var locJson = ConvertJson.ConvertDataToJson (locData);
			Intent broadcast = new Intent();
			broadcast.SetAction(StaticValue.GCMMESSAGE);
			broadcast.PutExtra(StaticValue.RESULT, msg.ToString());
			this.SendBroadcast(broadcast);

			Log.Info(TAG, "GCM Message Received!" + msg.ToString());
